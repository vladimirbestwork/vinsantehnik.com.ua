...
<!-- OC-Store: Badges -->
				<li><a href="#tab-badges" data-toggle="tab"><?php echo $tab_badges; ?></a></li>
				<!-- /OC-Store: Badges -->
          </ul>
				...
				<div class="tab-pane" id="tab-badges">
				  <div class="table-responsive">
					<div class="form-group" style="margin: 0px">
					  <label class="col-sm-2 control-label" for="input-badges"><?=$entry_badges;?></label>
					  <div class="col-sm-10">
						<div class="well well-sm">
						  <?php foreach ($badges as $b) { ?>
							<label data-toggle="tooltip" title="<img src='<?=HTTPS_CATALOG;?>image/<?=$b['image'];?>' />" >
							  <input type="checkbox" name="badges[]" value="<?=$b['id'];?>" <?=(in_array($b['id'], $badges_product) !== false? "checked": "");?> /> <?=$b['name'];?>
							</label><br/>
						  <?php } ?>
						</div>
					  </div>
