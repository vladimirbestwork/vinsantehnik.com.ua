...
/* OC-Store: Badges */
				$this->db->query("DELETE FROM " . DB_PREFIX . "ocstore_badges_product WHERE product_id = " . (int)$product_id)." and `auto` = 0";
				if (isset($data['badges']))
					foreach ($data['badges'] as $bId)
						$this->db->query("INSERT INTO `" . DB_PREFIX . "ocstore_badges_product` SET `product_id` = " . (int)$product_id . ", badge_id = ".(int)$bId);
				/* /OC-Store: Badges */
