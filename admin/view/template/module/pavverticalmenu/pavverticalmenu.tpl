...
<div id="content">
	...
	<div class="page-header">
		<div class="container-fluid">
			<div class="pull-right">
				...
				<a class="btn btn-info" title="<?php echo $objlang->get('Guide'); ?>" id="btn-guide" href="http://www.pavothemes.com/"><?php echo $objlang->get('Guide');?></a>
			</div>
	...
	<div id="page-content" class="container-fluid">
		...
		<div id="info" style="font-size:10px;color:#666"><p>Pav Mega Menu бесплатный  модуль и распространяется по лицензии GPL/V2. Powered By <a href="http://www.pavothemes.com">PavoThemes.Com</a></div>
	</div><!-- container-fluid -->
</div>
...
<div id="cmodal" class="modal fade deleteTree-modal-sm" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
	<div class="modal-dialog modal-sm">
		<div class="modal-content">
			...
			<div class="modal-footer">
				<button type="button" class="btn btn-default" data-dismiss="modal"><?php echo $text_no; ?></button>
				<button type="button" class="btn btn-primary" id="btnDeleteTree"><?php echo $text_yes; ?></button>
			</div>
