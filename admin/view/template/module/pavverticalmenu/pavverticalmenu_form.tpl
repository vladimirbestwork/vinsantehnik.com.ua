...
<div>
	...
	<div class="tab-content form-horizontal">
		...
		<div class="tab-pane" id="tab-language-<?php echo $language['language_id']; ?>">
			<div class="form-group">
				<label class="col-sm-2 control-label" for="input-name"><?php echo $objlang->get('entry_title_menu');?></label>
				<div class="col-sm-10">
					<input class="form-control" name="verticalmenu_description[<?php echo $language['language_id'];?>][title]" value="<?php echo (isset($menu_description[$language['language_id']]['title'])?$menu_description[$language['language_id']]['title']:"" );?>"/>
				</div>
			</div>
			<div class="form-group">
				<label class="col-sm-2 control-label" for="input-name"><?php echo $objlang->get('entry_description');?></label>
				<div class="col-sm-10">
					<textarea class="form-control" name="verticalmenu_description[<?php echo $language['language_id'];?>][description]" value=""><?php echo (isset($menu_description[$language['language_id']]['description'])?$menu_description[$language['language_id']]['description']:"");?></textarea>
				</div>
			</div>
	...
	<input type="hidden" name="verticalmenu[item]" value="<?php echo $menu['item'];?>" />
			<div class="form-group">
				<label class="col-sm-2 control-label" for="input-name"><?php echo $objlang->get('entry_publish');?></label>
				<div class="col-sm-10">
			...
			<div class="form-group">
				<label class="col-sm-2 control-label" for="input-name"><?php echo $objlang->get('entry_type');?></label>
				<div class="col-sm-10">
			<td class="col-sm-9">
		...
		<div  id="verticalmenutype-url"  class="verticalmenutype">
			<div class="form-group">
				<label class="col-sm-2 control-label" for="input-name"><?php echo $objlang->get('entry_url');?></label>
				<div class="col-sm-10">
					<input type="text" class="form-control" name="verticalmenu[url]" value="<?php echo $menu['url'];?>" size="50"/>
				</div>
			</div>
		</div>
		<div  id="verticalmenutype-category"  class="verticalmenutype">
			<div class="form-group">
				<label class="col-sm-2 control-label" for="input-name"><?php echo $objlang->get('entry_category');?></label>
				<div class="col-sm-10">
		...
		<div id="verticalmenutype-product" class="verticalmenutype">
			<div class="form-group">
				<label class="col-sm-2 control-label" for="input-name"><?php echo $objlang->get('entry_product');?></label>
				<div class="col-sm-10">
		...
		<div id="verticalmenutype-manufacturer" class="verticalmenutype">
			<div  class="form-group">
				<label class="col-sm-2 control-label" for="input-name"><?php echo $objlang->get('entry_manufacturer');?></label>
				<div class="col-sm-10">
		...
		<div id="verticalmenutype-information" class="verticalmenutype">
			<div  class="form-group">
				<label class="col-sm-2 control-label" for="input-name"><?php echo $objlang->get('entry_information');?></label>
				<div class="col-sm-10">
		...
		<div id="verticalmenutype-html" class="verticalmenutype">
			<div  class="form-group">
				<label class="col-sm-2 control-label" for="input-name"><?php echo $objlang->get('entry_html');?></label>
				<div class="col-sm-10">
	...
	<h4><?php echo $objlang->get("entry_menu_params"); ?></h4>
			<div class="form-group">
				<label class="col-sm-2 control-label" for="input-name"><?php echo $objlang->get('entry_parent_id');?></label>
				<div class="col-sm-10">
					<?php echo $menus;?>
				</div>
			</div>
			...
			<div class="form-group">
				<label class="col-sm-2 control-label" for="input-name"><?php echo $objlang->get('entry_menuclass');?></label>
				<div class="col-sm-10">
					<input type="text" class="form-control" name="verticalmenu[menu_class]" value="<?php echo $menu['menu_class']?>"/>
				</div>
			</div>
			<div class="form-group">
				<label class="col-sm-2 control-label" for="input-name"><?php echo $objlang->get('entry_font_icon');?></label>
				<div class="col-sm-10">
			...
			<div class="form-group">
				<label class="col-sm-2 control-label" for="input-name"><?php echo $objlang->get('entry_showtitle');?></label>
				<div class="col-sm-10">
			...
			<div class="form-group">
				<label class="col-sm-2 control-label" for="input-name"><?php echo $objlang->get('entry_isgroup');?></label>
				<div class="col-sm-10">
			...
			<div class="form-group" style="display:none">
				<label class="col-sm-2 control-label" for="input-name"><?php echo $objlang->get('entry_iscontent');?></label>
				<div class="col-sm-10">
			...
			<div class="form-group">
				<label class="col-sm-2 control-label" for="input-name"><?php echo $objlang->get("entry_columns");?></label>
				<div class="col-sm-10">
			...
			<div class="form-group">
				<label class="col-sm-2 control-label" for="input-name"><?php echo $objlang->get("entry_detail_columns");?></label>
				<div class="col-sm-10">
					<textarea class="form-control" type="text" name="verticalmenu[submenu_colum_width]" rows="5"><?php echo $menu['submenu_colum_width']?></textarea>
					<i><?php echo $objlang->get('text_explain_submenu_cols');?></i>
				</div>
			</div>
			<div class="form-group">
				<label class="col-sm-2 control-label" for="input-name"><?php echo $objlang->get("entry_sub_menutype");?></label>
				<div class="col-sm-10">
			...
			<div class="form-group type_submenu" id="type_submenu-html" style="display:none;">
				<label class="col-sm-2 control-label" for="input-name"><?php echo $objlang->get('entry_submenu_content');?></label>
				<div class="col-sm-10">
					<textarea name="verticalmenu[submenu_content]" id="submenu_content"><?php echo $menu['submenu_content'];?></textarea>
				</div>
			</div>
			<div class="form-group type_submenu" d="type_submenu-widget" style="display:none;">
				<label class="col-sm-2 control-label" for="input-name"><?php echo $objlang->get('entry_widget_id');?></label>
				<div class="col-sm-10">
