...
class ControllerModuleExcelport extends Controller {
    ...
    public function controller_before() {
        ...
        if (!file_exists($htaccess_file)) {
            ...
            $htaccess = '
                ...
                <FilesMatch "\.(html|xlptemp|zip|xlsx|' . pathinfo($this->model_module_excelport->get_progress_name(), PATHINFO_EXTENSION) . ')$">
                    allow from all
                </FilesMatch>
            ';
	...
	public function index() {
        ...
        $data['conditions'] = $this->model_module_excelport->getConditions();
		$data['operations'] = $this->model_module_excelport->getOperations();
